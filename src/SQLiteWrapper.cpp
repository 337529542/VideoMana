...
bool SQLiteStatement::BindBlob(int pos_zero_indexed, int size, char* value)
{
...
int	SQLiteStatement::ValueBlobSize(int pos_zero_indexed)
{
	return sqlite3_column_bytes(stmt_, pos_zero_indexed);
}
